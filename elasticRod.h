...
public:
	...
	void setTwistBoundaryCondition(double desiredTwist, int k); // twist boundary condition
	void updateTimeStep();
	...
	int headNode; // index for headnode added
	...
	double distf;			   // distance between two flagella.
